		...
		btnAgregar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Funcionario fun =new Funcionario( textFieldNombre.getText(), textFieldCi.getText(), textFieldCorreo.getText(), textFieldTelefono.getText(), textFieldCiudad.getText(), textFieldDireccion.getText(), textFieldContrasenia.getText(), LocalDate.of(Integer.parseInt(fecha[2]), Integer.parseInt(fecha[1]), Integer.parseInt(fecha[0])), LocalDate.now(), true, admin);
					if(admin) {
