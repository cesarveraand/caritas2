...
boolean confirm=true;
					...
					if(confirm) {
						...
						Funcionario fun =new Funcionario(f.getCod(), textFieldNombre.getText(), textFieldCi.getText(), textFieldCorreo.getText(), textFieldTelefono.getText(), textFieldCiudad.getText(), textFieldDireccion.getText(), textFieldContrasenia.getText(), LocalDate.of(Integer.parseInt(fecha[2]), Integer.parseInt(fecha[1]), Integer.parseInt(fecha[0])), LocalDate.now(), true, rdbtnAdmin.isSelected());
						...
						dispose();
							...
							JOptionPane.showMessageDialog(null, "No puede usar el mismo CI para crear otro usuario de Administrador");
						}
			...
			public void actionPerformed(ActionEvent e) {
				try {
					boolean confirm=true;
						...
						Funcionario fun =new Funcionario(f.getCod(), textFieldNombre.getText(), textFieldCi.getText(), textFieldCorreo.getText(), textFieldTelefono.getText(), textFieldCiudad.getText(), textFieldDireccion.getText(), textFieldContrasenia.getText(), LocalDate.of(Integer.parseInt(fecha[2]), Integer.parseInt(fecha[1]), Integer.parseInt(fecha[0])), LocalDate.now(), false, rdbtnAdmin.isSelected());
