...
public class Registro extends JFrame {
	...
	public Registro() {
       ...
       comboBoxEnvio = new JComboBox<>(opcionesEnvio);
		...
		comboBoxEnvio.setBounds(242, 302, 124, 20);
		panelFormadeVida.add(comboBoxEnvio);
		comboBoxEnvio.setPreferredSize(new Dimension(150, 30));

		rdbtnSiLeEnvian.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lblMedioEnvio.setVisible(true);
				comboBoxEnvio.setVisible(true);
			}
		});
	...
	public Registro(FormlarioRegistro reg) {
       ...
       comboBoxEnvio = new JComboBox<>(opcionesEnvio);
		...
		comboBoxEnvio.setSelectedItem(reg.getMedioEvniaDinero());
		comboBoxComunicacion.setSelectedItem(reg.getComunicaFamilia());
