...
public class busquedaVoluntari extends JFrame {
	...
	private JTextField txtDatoABuscar;
	  private JRadioButton rdbtnNewRadioButton;
	    ...
	    private JRadioButton rdbtnCi;
	    private JRadioButton rdbtnNHojaDe;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					busquedaVoluntari frame = new busquedaVoluntari();
					frame.setTitle("Busqueda Voluntario");
	 ...
	 * Create the frame.
	 */
	public busquedaVoluntari() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(busquedaVoluntari.class.getResource("/imagenes_help/iconCaritas.png")));
        ...
        imagenCaritas.setIcon(new ImageIcon(busquedaVoluntari.class.getResource("/imagenes_help/caritas-bolivia.png")));
        ...
        ImageIcon iconOriginal = new ImageIcon(busquedaVoluntari.class.getResource("/imagenes_help/perfilpersona.png"));
     ...
     // Agrupar los JRadioButtons para permitir solo una selección
		...
		for (Voluntariod voluntario : listaVoluntarios) {
		    ...
		    Image imagenOriginal1 = iconPerfil.getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH);
		    ImageIcon iconRedimensionado = new ImageIcon(imagenOriginal1);
		    JLabel labelImagen = new JLabel(iconRedimensionado); // Imagen de perfil
		    ...
		    // Crear un panel para los detalles
		    JPanel panelDetalles = new JPanel();
		    panelDetalles.setLayout(new GridLayout(0, 1)); // Diseño para los detalles del refugiado
...
//OJOJ
		    // Botón del basurero
		    ImageIcon iconBasurero = new ImageIcon(BusquedaRefugiado.class.getResource("/imagenes_help/basurero.png"));
		    ...
		    buttonVoluntario.add(panelImagen, BorderLayout.WEST);
		    buttonVoluntario.add(panelDetalles, BorderLayout.CENTER);

		    // Agregar botón de basurero en la esquina inferior derecha
		    buttonVoluntario.add(panelBasurero, BorderLayout.SOUTH);
		    ...
		    buttonVoluntario.addActionListener(e -> {
		        // Aquí puedes especificar la acción al hacer clic en el botón de la tarjeta
		    ...
		    panelTarjetas.add(buttonVoluntario); // Agregar la "tarjeta" al panel de tarjetas
		}
