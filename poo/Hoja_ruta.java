...
public class Hoja_ruta extends JFrame {
	...
	public Hoja_ruta() {
		...
		int personas = Main.getUltimoForm().getFam().getCantidad(); // Debería ser la misma ingresada en la hoja de
																	// registro (no se debería volver a llenar)
		...
		txtFechaAsignacion.setBounds(453, 233, 130, 26);
		panelAsesoramientos.add(txtFechaAsignacion);
		...
		btnRegistrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (validarFecha(txtFechaAsignacion.getText())) {
					if (alMenosUnCheckBoxSeleccionado(chckbxAyudaHumanitaria, chckbxInfCondonación, chckbxPasajes,
							chckbxAimentacion, chckbxAlbergue, chckbxAseLegal, chckbxServiciosMedicos, chckbxSoliRefugio, chckbxAtenSocial)) {
						if (!txtNombresBenef.getText().equals("") && !txtObservaciones.getText().equals("")) {
							if (!txtAsignacion.getText().equals("") || !txtFechaAsignacion.getText().equals("")) {
								if (!txtFechaAsignacion.getText().equals("") && !txtAsignacion.getText().equals("")) {
									hj = new Hoja_de_ruta(cod, txtNumero.getText(), personas,
											txtObservaciones.getText(), chckbxAseLegal.isSelected(),
											chckbxSoliRefugio.isSelected(), chckbxAtenSocial.isSelected(),
											chckbxAlbergue.isSelected(), chckbxServiciosMedicos.isSelected(),
											chckbxAimentacion.isSelected(), chckbxAyudaHumanitaria.isSelected(),
											chckbxPasajes.isSelected(), chckbxInfCondonación.isSelected(),
											txtAsignacion.getText(), Extras.fechas(txtFechaAsignacion.getText()),
											Main.getUltimoForm(), true);
								...
								hj = new Hoja_de_ruta(cod, txtNumero.getText(), personas, txtObservaciones.getText(),
										...
										chckbxInfCondonación.isSelected(), Main.getUltimoForm(), true);
						...
						if (!txtAsignacion.getText().equals("") || !txtFechaAsignacion.getText().equals("")) {
							if (!txtFechaAsignacion.getText().equals("") && !txtAsignacion.getText().equals("")) {
								hj = new Hoja_de_ruta(cod, txtNumero.getText(), personas, txtObservaciones.getText(),
										...
										Extras.fechas(txtFechaAsignacion.getText()), Main.getUltimoForm(), true);
	...
	public Hoja_ruta(Hoja_de_ruta hj) {
		...
		txtFechaAsignacion.setText(hj.getFechaAsig() + "");
